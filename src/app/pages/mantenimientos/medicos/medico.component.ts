...
export class MedicoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.medicoForm.get('hospital').valueChanges  // Esto hace que al estar trabajando con formularios reactivos podemos estar pendiendes de sus cambios
  ...
  guardarMedico(){
    ...
    if(this.medicoSeleccionado){ // si existe quiere decir que quiere actualizar y no grabar otro
      //Actualizar
      const data = {
